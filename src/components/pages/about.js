  ...
  render() {
    let members = [
      {
        ...
        image:
          "https://pkimgcdn.peekyou.com/afb9ebbf22f634f59bacdc53d5cf4165.jpeg"
      },
      {
        firstName: "Siamak",
        lastName: "Samie",
      ...
      },
      {
        ...
        lastName: "Shade",
        description:
          "CHain Smoker with a cool stage name. Likes beer choking himself for pleasure",
        descriptionLong:
          "Adam Shade is a ladie's man... just jokes all he does is smoke and watch porn",
        image:
    ...
    return (
      <div className="container-fluid about">
        <h2>Our mission</h2>
        <p>
          Kdy productions was initially created for the purpose of creating
          highly creative, intensive, and dynamic action videos. Throughout the
          years, we've evolved and now offer a multitude of services. From
          corporate videos, to feature films, we've got the right people and the
          right attitude.
        </p>
        <hr />
        {member}
